...
In this project, the goal was to write a software pipeline to identify the lane boundaries in a video, but the main output or product was to create a detailed writeup of the project. Video of the final result is [here](./output_images/final.mp4).
...
Video is [here](./output_images/final.mp4)
